...
//                    System.out.println("read a line:" + line);
	...
	public static boolean convertEncode(String in, String encode1, String out, String encode2) {
		MyFile myFile = new MyFile(in, encode1);
		MyFile myFile1 = new MyFile(out, encode2);
		String line;
		try {
			line = myFile.readLine();
			while (line != null) {
				myFile1.writeLine(line);
				line = myFile.readLine();
			}
		} catch (IOException e) {
			e.printStackTrace();
