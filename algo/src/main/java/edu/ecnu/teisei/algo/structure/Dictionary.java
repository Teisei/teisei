...
import edu.ecnu.teisei.utils.MultiValueMap;
import edu.ecnu.teisei.utils.MyCollection;
...
public class Dictionary {
    ...
    private TreeMap<String, int[]> index = new TreeMap<>();
    ...
    private void createIndex() {
        ...
        for(Map.Entry<String, TreeSet<Integer>> entry: indexT.entrySet()) {
